...
angular
  ...
  .constant("CONFIG", {
    ...
    // baseTwoUrl: "http://localhost:4060/api/v2/",
    ...
    function($q, $cordovaCamera, $cordovaFileTransfer, CONFIG, fs, Storage) {
      return {
        ...
        uploadPicture: function(imgURI, temp_photoaddress) {
          return $q(function(resolve, reject) {
            var uri = encodeURI(
              CONFIG.baseTwoUrl + "upload?token=" + Storage.get("TOKEN")
            );
        ...
        uploadVoice: function(voiURI, temp_voiceaddress) {
          return $q(function(resolve, reject) {
            ...
            // var q = $q.defer();
            // console.log("jinlaile");
            $cordovaFileTransfer.upload(uri, voiURI, options).then(
              function(r) {
                console.log("Code = " + r.responseCode);
                console.log("Response = " + r.response);
                console.log("Sent = " + r.bytesSent);
      ...
      var Doctor = function() {
        return $resource(
          ...
          { path: "doctor" },
          {
            ...
            getMyGroupList: {
              method: "GET",
              params: { route: "myTeams" },
              timeout: 100000
            },
            getGroupPatientList: {
              method: "GET",
              params: { route: "teamPatients" },
              timeout: 100000
            },
            getRecentDoctorList: {
              method: "GET",
              params: { route: "myRecentDoctors" },
              timeout: 100000
            },
            editDoctorDetail: {
              method: "POST",
            ...
            insertSchedule: {
              method: "POST",
              params: { route: "schedule" },
              timeout: 10000
            },
            getSchedules: {
              method: "GET",
              params: { route: "schedules" },
              timeout: 10000
            },
            deleteSchedule: {
              method: "POST",
              params: { route: "deleteSchedule" },
              timeout: 10000
            },
            getSuspendTime: {
              method: "GET",
              params: { route: "suspendTime" },
              timeout: 10000
            },
            insertSuspendTime: {
              method: "POST",
            ...
            deleteSuspendTime: {
              method: "POST",
              params: { route: "deleteSuspendTime" },
              timeout: 10000
            },
            // getPatientByDate: {method: 'GET', params: {route: 'myPatientsByDate'}, timeout: 10000},
            getDocNum: {
              method: "GET",
              params: { route: "numbers" },
              timeout: 10000
            },
            getAliPayAccount: {
              method: "GET",
              params: { route: "AliPayAccount" },
              timeout: 10000
            },
            editAliPayAccount: {
              method: "POST",
      ...
      var Communication = function() {
        return $resource(
          ...
          { path: "communication" },
          {
            ...
            removeMember: {
              method: "POST",
              params: { route: "removeMember" },
              timeout: 100000
            },
            updateLastTalkTime: {
              method: "POST",
              params: { route: "updateLastTalkTime" },
              timeout: 100000
            },
            getConsultation: {
              method: "GET",
      ...
      var services = function() {
        return $resource(
          ...
          { path: "services" },
          {
            ...
            relayTarget: {
              method: "POST",
              params: { route: "relayTarget" },
              timeout: 100000
            },
            deleteSuspend: {
              method: "POST",
              params: { route: "deleteSuspend" },
              timeout: 100000
            },
            setSuspend: {
              method: "POST",
              params: { route: "setSuspend" },
              timeout: 100000
            },
            myPDpatients: {
              method: "GET",
              params: { route: "myPDpatients" },
              timeout: 100000
            },
            PDConfirmation: {
              method: "POST",
              params: { route: "PDConfirmation" },
              timeout: 100000
            }
          }
        );
      ...
      var Doctor2 = function() {
        return $resource(
          ...
          { path: "doctor" },
          {
            getReviewList: {
              method: "GET",
              params: { route: "myPatientsToReview" },
              timeout: 100000
            },
            saveReviewInfo: {
              method: "POST",
              params: { route: "PatientInCharge" },
              timeout: 100000
            },
            getPatientList: {
              method: "GET",
              params: { route: "myPatients" },
              timeout: 100000
            },
            sendgroupPatient: {
              method: "POST",
              params: { route: "groupPatient" },
              timeout: 100000
            },
            getPatientByDate: {
              method: "GET",
              params: { route: "myPatientsByDate" },
              timeout: 10000
            }
          }
        );
  ...
  .factory("MassCommunication", [
    "$q",
    "Data",
    "Storage",
    function($q, Data, Storage) {
      var self = this;
    ...
    function($q, Data) {
      ...
      function addLastMsg(type, userId, msg) {
        ...
        try {
          ...
          if (type == "11" || type == "12")
            msg.readOrNot = msg.readOrNot || (userId == msg.url.fromID ? 1 : 0);
        } catch (e) {}
        return msg;
      }
  ...
  .factory("QRScan", [
    ...
    "$ionicLoading",
    "$q",
    function($cordovaBarcodeScanner, $ionicLoading, $q) {
      return {
        getCode: function() {
          return $q(function(resolve, reject) {
  ...
  .factory("session", [
    ...
    "socket",
    "mySocket",
    function(Storage, socket, mySocket) {
      return {
        logOut: function() {
                          ...
                          if (window.cordova && window.cordova.InAppBrowser) {
                            if (ionic.Platform.isIOS()) {
                              window.cordova.InAppBrowser.open(
                                "https://itunes.apple.com/cn/app/%E8%82%BE%E4%BA%8B%E8%81%94%E7%9B%9F/id1276109371?mt=8",
                                "_system"
                              );
